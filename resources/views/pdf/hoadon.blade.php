    ...
    <div class="container">
        ...
        <div class="body">
            <div class="khachhang">
                ...
                <br><b>Họ tên khách hàng:</b> {{$dataKH->fullname}}
                <br><b>Số điện thoại:</b> {{$dataKH->phone }}
                <br><b>Thời gian đặt hàng:</b> {{$dataKH->Ngay_dat_hang}}
                <br><b>Địa chỉ giao hàng:</b> {{$dataKH->address }}
                <br><b>Tổng tiền phải thanh toán:</b> {{number_format((float)$dataKH->amount,0,",",".")}} đ
                @endforeach
